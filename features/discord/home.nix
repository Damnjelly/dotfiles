...
{
  options.features.discord.enable = lib.mkEnableOption "discord";

  config = lib.mkIf config.features.discord.enable {
    home = {
      packages = with pkgs; [
        vesktop # discord client
        rubik # font for discord
      ];
    ...
    xdg.configFile."vesktop/themes/systemd24.theme.css".text =
      ...
      ''
        ...
        /* @import url('https://refact0r.github.io/system24/src/unrounding.css'); gets rid of all rounded corners. remove if you want rounded corners. */
         ...
         :root {
         	--font: 'rubik'; /* UI font name. it must be installed on your system. */
         	...
         	/* background colors */
         	--bg-0: ${base00}; /* main background color. */
         	--bg-1: ${base01}; /* background color for secondary elements like code blocks, embeds, etc. */
         	--bg-2: ${base02}; /* color of neutral buttons. */
         	--bg-3: ${base03}; /* color of neutral buttons when hovered. */

         	/* state modifiers */
         	--hover: ${base02}; /* color of hovered elements. */
         	--active: ${base01}; /* color of elements when clicked. */
         	...
         	--txt-0: ${base07}; /* color of bright/white text. */
         	--txt-1: ${base05}; /* main text color. */
         	--txt-2: ${base06}; /* color of secondary text like channel list. */
         	--txt-3: ${base04}; /* color of muted text. */
